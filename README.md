...
Clicking on a step added to a script will show the adb commmand that actually that step executes and offers the option to delete the step from the current script:

...
def get_supported_steps():
    return [
        ...
        get_step(
            ...
            commands=[Command("shell pm clear " + PARAMETER_PLACEHOLDER + "1",
                              True)],
        ...
        get_step(
            ...
            commands=[
                Command("shell uiautomator dump", True),
                Command("pull /sdcard/window_dump.xml ./", True),
                Command(
        ...
        get_step(
            ...
            commands=[Command("shell input keyevent 4", True)],
            parameters_names=[],
            parameters_descriptions={}
        ),
        get_step(
            name=COMMAND_INPUT_TEXT_ON_KEYBOARD_NAME,
            commands=[Command("shell input text \"" + PARAMETER_PLACEHOLDER + "1\"", True)],
        ...
        get_step(
            ...
            commands=[Command("shell input keyevent 66", True)],
            parameters_names=[],
            parameters_descriptions={}
        ),
        get_step(
            ...
            commands=[
                Command("shell screencap -p /sdcard/screenshot.png", True),
                Command("pull /sdcard/screenshot.png " + PARAMETER_PLACEHOLDER + "1", True)
            ],
        ...
        get_step(
            ...
            commands=[Command("shell pm reset-permissions -p " + PARAMETER_PLACEHOLDER + "1", True)],
            parameters_names=["Application id"],
            parameters_descriptions={}
        ),
        get_step(
